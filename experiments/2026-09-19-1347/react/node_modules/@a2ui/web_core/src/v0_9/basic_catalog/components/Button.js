 ...
 */
let A2uiBasicButtonElement = class A2uiBasicButtonElement extends BasicCatalogA2uiLitElement {
    constructor() {
        super(...arguments);
        this.api = ButtonApi;
    }
 ...
 */
A2uiBasicButtonElement.styles = css `
    .a2ui-button {
      padding: var(
        --a2ui-button-padding,
  ...
  `;
A2uiBasicButtonElement = __decorate([
