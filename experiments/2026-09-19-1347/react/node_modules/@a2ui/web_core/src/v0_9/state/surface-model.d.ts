 ...
 *   implementations.
 */
export declare class SurfaceModel<T extends ComponentApi = ComponentApi, F extends FunctionApi = FunctionImplementation> {
    readonly id: string;
     ...
     */
    constructor(id: string, catalog: Catalog<T, F>, theme?: any, sendDataModel?: boolean);
    /**
