...
export declare class A2uiBasicButtonElement extends BasicCatalogA2uiLitElement<typeof ButtonApi> {
    ...
    protected readonly api: {
        ...
        schema: import("zod").ZodObject<{
            ...
            isValid: import("zod").ZodOptional<import("zod").ZodBoolean>;
            validationErrors: import("zod").ZodOptional<import("zod").ZodArray<import("zod").ZodString, "many">>;
            ...
            action: import("zod").ZodOptional<import("zod").ZodUnion<[import("zod").ZodObject<{
...
export declare const A2uiButton: WebComponentImplementation;
