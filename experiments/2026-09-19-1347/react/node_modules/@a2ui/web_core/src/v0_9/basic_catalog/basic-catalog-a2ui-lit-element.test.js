...
import { z } from 'zod';
import { ComponentContext, MessageProcessor, Catalog, } from '../index.js';
describe('BasicCatalogA2uiLitElement', () => {
    ...
    before(async () => {
        ...
        class TestBasicElement extends BasicCatalogA2uiLitElement {
            constructor() {
                super(...arguments);
                this.api = TestComponentApi;
            }
            render() {
                return html `<div class="inner">${this.controller?.props?.text ?? ''}</div>`;
            }
        }
        TestBasicElement.styles = css `
        :host {
          display: block;
          color: red;
        }
