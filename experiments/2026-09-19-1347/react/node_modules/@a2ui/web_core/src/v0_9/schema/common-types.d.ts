...
export declare function childRefKindOf(schema: z.ZodTypeAny): ChildRefKind | undefined;
export interface RefSchemaOptions {
    /** Prose appended after the `REF:` pointer; shown in generated capabilities. */
    readonly description?: string;
}
export declare function componentId(options?: RefSchemaOptions): typeof ComponentIdSchema;
/**
 * Describes a child-list property without losing its `REF:` pointer; the
 * same hazard {@link componentId} exists for.
 */
export declare function childList(options?: RefSchemaOptions): typeof ChildListSchema;
