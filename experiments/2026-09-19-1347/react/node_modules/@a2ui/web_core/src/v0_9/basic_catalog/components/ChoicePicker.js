...
let A2uiChoicePickerElement = class A2uiChoicePickerElement extends BasicCatalogA2uiLitElement {
    constructor() {
        super(...arguments);
        this.filter = '';
        this.api = ChoicePickerApi;
    }
    render() {
        ...
        const toggle = (val) => {
            ...
            if (isMulti) {
                if (selected.includes(val)) {
                    setter(selected.filter((v) => v !== val));
                }
                else {
                    setter([...selected, val]);
                }
 ...
 */
A2uiChoicePickerElement.styles = css `
    :host,
    .a2ui-choice-picker {
      display: flex;
...
__decorate([
    state()
], A2uiChoicePickerElement.prototype, "filter", void 0);
A2uiChoicePickerElement = __decorate([
