...
let A2uiBasicTextFieldElement = class A2uiBasicTextFieldElement extends BasicCatalogA2uiLitElement {
    constructor() {
        super(...arguments);
        this.api = TextFieldApi;
    }
    render() {
      ...
      ${isInvalid && props.validationErrors?.length
            ? props.validationErrors.map((err) => html `<div class="error">${err}</div>`)
            : nothing}
    `;
    }
};
 ...
 */
A2uiBasicTextFieldElement.styles = css `
    :host,
  ...
  `;
A2uiBasicTextFieldElement = __decorate([
