...
let A2uiCheckBoxElement = class A2uiCheckBoxElement extends BasicCatalogA2uiLitElement {
    constructor() {
        super(...arguments);
        this.api = CheckBoxApi;
    }
    render() {
      ...
      <div class="container">
        ...
        ${isInvalid && props.validationErrors?.length
            ? props.validationErrors.map((msg) => html `<div class="error a2ui-error-message">${msg}</div>`)
            : nothing}
      </div>
    `;
    }
 ...
 */
A2uiCheckBoxElement.styles = css `
    :host,
    a2ui-checkbox {
      display: block;
    }
  ...
  `;
A2uiCheckBoxElement = __decorate([
