...
export const ComponentIdSchema = markChildRef(z
    .string()
    .describe('REF:common_types.json#/$defs/ComponentId|The unique identifier for a component.'), 'component-id');
/**
...
export function childRefKindOf(schema) {
    return schema._def.a2uiChildRef;
}
export function componentId(options = {}) {
