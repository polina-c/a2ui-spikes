...
let A2uiDateTimeInputElement = class A2uiDateTimeInputElement extends BasicCatalogA2uiLitElement {
    constructor() {
        super(...arguments);
        this.api = DateTimeInputApi;
    }
    render() {
 ...
 */
A2uiDateTimeInputElement.styles = css `
  ...
  `;
A2uiDateTimeInputElement = __decorate([
