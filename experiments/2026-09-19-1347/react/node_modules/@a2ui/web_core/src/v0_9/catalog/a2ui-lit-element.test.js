...
describe('A2uiLitElement', () => {
    ...
    it('should default to Shadow DOM rendering (creates a ShadowRoot)', () => {
        ...
        assert.ok(el.createRenderRoot() instanceof globalThis.ShadowRoot ||
    ...
    it('should automatically instantiate controller when api property is defined', async () => {
        class TestApiElement extends A2uiLitElement {
            constructor() {
                super(...arguments);
                this.api = TextApi;
            }
        ...
        const el = document.createElement('test-api-element');
        document.body.appendChild(el);
        const context = new ComponentContext(surface, 'root');
        await asyncUpdate(el, e => {
            e.context = context;
    ...
    it('should safely skip update and render when context or controller is not set', async () => {
        ...
        class TestUnboundElement extends A2uiLitElement {
            constructor() {
                super(...arguments);
                this.api = TextApi;
            }
        ...
        const el = document.createElement('test-unbound-element');
        document.body.appendChild(el);
