...
describe('MessageProcessor', () => {
    ...
    describe('formatZodIssue and error reporting', () => {
        it('formats unrecognized keys with exact property names', () => {
            ...
            assert.strictEqual(formatZodIssue(issue), "header: Unrecognized key(s) in object: 'color', 'gap'");
        });
        ...
        it('formats invalid enum values', () => {
            ...
            assert.strictEqual(formatZodIssue(issue), "variant: Invalid enum value. Expected primary | secondary, received 'invalid'");
        });
        ...
        it('surfaces unrecognized property validation error and details when processing component updates', () => {
            ...
            assert.throws(() => {
                ...
                assert.strictEqual(err.message, "Validation failed for component 'MaterialButton' (btn1): root: Unrecognized key(s) in object: 'color'");
