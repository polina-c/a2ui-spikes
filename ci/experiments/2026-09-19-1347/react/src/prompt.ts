 ...
 *
 * a2ui ships a prompt generator (`DirectJsonFormat.generate_system_prompt`) in
 * its Python agent SDK only, so a browser-only app has to write this itself.
 * The component schemas are not hand-copied though: `getClientCapabilities`
 * turns the catalog into JSON Schema at runtime, and that goes into the prompt.
 */
