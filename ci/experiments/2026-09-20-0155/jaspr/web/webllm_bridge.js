...
// browser tab.
//
// The React arm imports @mlc-ai/web-llm through its bundler. A Jaspr app has no
// JavaScript bundler, so the library is loaded from a CDN as an ES module and
// its two useful calls are put on `window` for Dart to reach with
...
// the app starts; the dynamic import happens inside the first call.
(() => {
  'use strict';
